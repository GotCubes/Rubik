...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn14 = QtGui.QPushButton(self.centralwidget)
        self.btn14.setGeometry(QtCore.QRect(230, 70, 40, 40))
        self.btn14.setObjectName("btn14")
        self.btn41 = QtGui.QPushButton(self.centralwidget)
        self.btn41.setGeometry(QtCore.QRect(75, 225, 40, 40))
        self.btn41.setObjectName("btn41")
        self.btn44 = QtGui.QPushButton(self.centralwidget)
        self.btn44.setGeometry(QtCore.QRect(230, 225, 40, 40))
        self.btn44.setObjectName("btn44")
        self.btn47 = QtGui.QPushButton(self.centralwidget)
        self.btn47.setGeometry(QtCore.QRect(385, 225, 40, 40))
        self.btn47.setObjectName("btn47")
        self.btn410 = QtGui.QPushButton(self.centralwidget)
        self.btn410.setGeometry(QtCore.QRect(540, 225, 40, 40))
        self.btn410.setObjectName("btn410")
        self.btn74 = QtGui.QPushButton(self.centralwidget)
        self.btn74.setGeometry(QtCore.QRect(230, 380, 40, 40))
        self.btn74.setObjectName("btn74")
        self.btnM = QtGui.QPushButton(self.centralwidget)
        self.btnM.setGeometry(QtCore.QRect(670, 530, 50, 50))
        self.btnM.setObjectName("btnM")
        self.btnMp = QtGui.QPushButton(self.centralwidget)
        self.btnMp.setGeometry(QtCore.QRect(725, 530, 50, 50))
        self.btnMp.setObjectName("btnMp")
        self.btnM2 = QtGui.QPushButton(self.centralwidget)
